    ...
    def filter_function(self, account: Account, transaction: pd.Series):
        return "PAYMENT TO xxxxxx3890" in transaction.description or \
                ...
                ("VENMO CASHOUT ACH CREDIT" in transaction.description and
                 ...
                 "CHASE CREDIT CRD EPAY" in transaction.description and transaction.date >= datetime(2025, 9, 1) or \
                (isinstance(account, Chase) and
                 transaction.date >= datetime(2025, 9, 1))
